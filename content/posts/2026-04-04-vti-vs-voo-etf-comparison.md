...
date: 2026-04-04
draft: false
tags: ["ETF", "米国株", "インデックス投資", "NISA", "ポートフォリオ・分散", "長期投資", "VOO"]
categories: ["ETF・投資信託"]
...
どちらも[バンガード（Vanguard）](https://www.vanguard.co.jp/)が運用する超低コストETFで、長期投資の定番。経費率もほぼ同じ、リターンも似ている。それなのに、投資家の間では「VTI派」と「VOO派」に分かれることが多く、SNSやブログでは今も議論が続いています。
...
両者の共通点：
- 業界最低水準の経費率（年0.03%）
- [バンガード](https://www.vanguard.co.jp/)の高い信頼性と運用規模
- 長期的には似たリターン水準
- 新NISAでも活用可能
