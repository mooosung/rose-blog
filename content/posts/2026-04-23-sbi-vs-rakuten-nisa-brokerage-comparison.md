...
**[SBI証券](https://www.sbisec.co.jp/)**は、SBIグループが運営する国内最大級のネット証券です。口座数は1,300万口座を超え、取扱商品の豊富さと低コストで支持されています。

**[楽天証券](https://www.rakuten-sec.co.jp/)**は楽天グループが運営し、楽天ポイントとの連携が最大の強みです。楽天市場や楽天カードを使っているユーザーにとっては特に相性が抜群です。
