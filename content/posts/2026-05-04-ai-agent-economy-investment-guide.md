...
[McKinsey Global Institute](https://www.mckinsey.com/mgi)の試算では、AIエージェントの普及により、**知識労働の30〜70%が自動化可能**になるとされています。
...
**注目銘柄：**
- **[NVIDIA](https://www.nvidia.com/)（NVDA）**：AIエージェントの学習・推論に不可欠なGPUの独占的供給者。2026年以降もBlackwellアーキテクチャで需要が継続。
