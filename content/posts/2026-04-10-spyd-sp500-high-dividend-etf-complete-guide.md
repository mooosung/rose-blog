...
運用会社は[State Street Global Advisors](https://www.ssga.com/jp)（ステート・ストリート）。世界最大の資産運用会社のひとつが運用しており、信頼性の面でも安心できます。
...
- **[SBI証券](https://www.sbisec.co.jp/)**：米国株取引から購入可能。円からの自動換算あり
- **楽天証券**：同様に米国株として購入可能
