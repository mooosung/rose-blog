---
title: "VOO・IVV・SPY徹底比較｜S&P500 ETF2026年最強の選び方完全ガイド"
date: 2026-05-23
draft: false
...
[バンガード](https://www.vanguard.com/)が2010年に設定したETFです。同社は投資家所有の相互会社という独特の構造を持ち、「低コスト投資の伝道師」として知られています。
...
世界最大の資産運用会社[ブラックロック](https://www.blackrock.com/)が運用するETFです。VOOと同じ0.03%の経費率を維持しながら、長い運用実績（2000年設定）を誇ります。
...
### Q1: VOO・IVV・SPYはどれも同じS&P500に連動するのに、なぜ3本もあるのですか？

運用会社が異なり（バンガード・ブラックロック・ステートストリート）、経費率・流動性・設定年が異なります。SPYは1993年設定で流動性が最も高くトレード向き、VOOとIVVは経費率0.03%と最安水準で長期積立向きです。投資スタイルに合わせて選ぶことが重要です。

### Q2: NISAでVOO・IVV・SPYは買えますか？

はい、3本ともNISAの成長投資枠（年間240万円）で購入可能です。ただし、つみたて投資枠では海外ETFを直接購入できないため、つみたて枠を使いたい場合はeMAXIS Slim米国株式（S&P500）などの国内投資信託を利用しましょう。

### Q3: S&P500 ETFの配当金には税金がかかりますか？

米国ETFの配当金には米国で10%、日本で約20.315%の二重課税がかかります。確定申告で外国税額控除を申請すれば米国課税分の一部を取り戻せます。NISA口座では日本側の課税は非課税ですが、米国の10%は控除申請ができない点に注意が必要です。

### Q4: 初心者はVOO・IVV・SPYのどれを選ぶべきですか？

長期積立を目的とする初心者にはVOOがおすすめです。経費率0.03%と最安水準で、バンガードの低コスト運用哲学に基づいた商品です。IVVも同等のコストなので、好みの運用会社で選んで問題ありません。短期トレード目的でなければSPYはコスト面でやや不利です。
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "VOO・IVV・SPYはどれも同じS&P500に連動するのに、なぜ3本もあるのですか？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "運用会社が異なり（バンガード・ブラックロック・ステートストリート）、経費率・流動性・設定年が異なります。SPYは1993年設定で流動性が最も高くトレード向き、VOOとIVVは経費率0.03%と最安水準で長期積立向きです。投資スタイルに合わせて選ぶことが重要です。"
      }
    },
    {
      "@type": "Question",
      "name": "NISAでVOO・IVV・SPYは買えますか？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "はい、3本ともNISAの成長投資枠（年間240万円）で購入可能です。ただし、つみたて投資枠では海外ETFを直接購入できないため、つみたて枠を使いたい場合はeMAXIS Slim米国株式（S&P500）などの国内投資信託を利用しましょう。"
      }
    },
    {
      "@type": "Question",
      "name": "S&P500 ETFの配当金には税金がかかりますか？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "米国ETFの配当金には米国で10%、日本で約20.315%の二重課税がかかります。確定申告で外国税額控除を申請すれば米国課税分の一部を取り戻せます。NISA口座では日本側の課税は非課税ですが、米国の10%は控除申請ができない点に注意が必要です。"
      }
    },
    {
      "@type": "Question",
      "name": "初心者はVOO・IVV・SPYのどれを選ぶべきですか？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "長期積立を目的とする初心者にはVOOがおすすめです。経費率0.03%と最安水準で、バンガードの低コスト運用哲学に基づいた商品です。IVVも同等のコストなので、好みの運用会社で選んで問題ありません。短期トレード目的でなければSPYはコスト面でやや不利です。"
      }
    }
  ]
}
